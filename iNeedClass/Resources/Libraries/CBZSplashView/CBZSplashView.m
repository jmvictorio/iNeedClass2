...
- (instancetype)initWithIcon:(UIImage *)icon backgroundColor:(UIColor *)backgroundColor
{
  self = [super init];
  if (self) {
      _icons=[[NSMutableArray alloc]initWithObjects:[UIImage imageNamed:@"Business-Situations_05_01"],
                                                    [UIImage imageNamed:@"Business-Situations_05_02"],
                                                    [UIImage imageNamed:@"Business-Situations_05_03"],
                                                    [UIImage imageNamed:@"Business-Situations_05_04"],
                                                    [UIImage imageNamed:@"Business-Situations_05_05"],
                                                    [UIImage imageNamed:@"Business-Situations_05_06"],
                                                    [UIImage imageNamed:@"Business-Situations_05_07"],
                                                    [UIImage imageNamed:@"Business-Situations_05_08"],
                                                    [UIImage imageNamed:@"Business-Situations_05_09"],
